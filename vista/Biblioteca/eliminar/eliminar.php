...
<?php 
 ...
 ?>
    ...
    <center><a href="controler-sub.php?accion=eliminar&id=<?php echo $id?>" class='btn_modificar'>Estoy seguro</a><a href="controler-sub.php" class='btn_eliminar'>Cancelar</a></center>
