	<div id='sidebar'>
		...
		<ul id='list'>
			<li>
				<img src='../../storage/imagenes/patrimonio.png' class='logo' style='padding:15px 10px;' />
			</li>
			<li><a href='<?php echo $carpeta_trabajo;?>/controladores/Biblioteca/Subir_archivo/controler-sub.php' class='sideButtom'><i class="ri-book-mark-line"></i>Biblioteca</a></li>
